...
class TestFileDashboardViews:
    def test_supports_get_request(self, api_client: APIClient, create_user: Callable,
...
class TestFileUploadByChunksView:
    ...
    def test_returns_404_when_file_does_not_exist(self, api_client: APIClient, create_user: Callable,
                                                  create_token_for_user: Callable) -> None:
    ...
    def test_post_returns_400_when_invalid_data(self, api_client: APIClient, create_user: Callable,
                                                create_token_for_user: Callable) -> None:
        url = reverse('upload-chunks')
        api_client.credentials(HTTP_Access_Token=create_token_for_user(create_user()))
...
class TestDetailView:
    ...
    def test_supports_put_request(self, api_client: APIClient, create_user: Callable,
                                  create_token_for_user: Callable,
                                  create_file: Callable) -> None:
        user = create_user()
        file = create_file(user)
    ...
    def test_supports_delete_request(self, api_client: APIClient, create_user: Callable,
                                     create_token_for_user: Callable,
                                     create_file: Callable) -> None:
        user = create_user()
        file = create_file(user)
    ...
    def test_get_returns_401_when_unauthenticated(self, api_client: APIClient, create_file: Callable,
    ...
    def test_put_returns_401_when_unauthenticated(self, api_client: APIClient, create_file: Callable,
                                                  create_user: Callable) -> None:
        url = reverse('detail', kwargs={'primary_key': str(create_file(create_user()).id)})
        data = {'description': 'test file description'}
    ...
    def test_delete_returns_401_when_unauthenticated(self, api_client: APIClient, create_file: Callable,
                                                     create_user: Callable) -> None:
        user = create_user()
        file = create_file(user)
        url = reverse('detail', kwargs={'primary_key': str(file.id)})
...
class TestDownloadSingleView:
    ...
    def test_returns_401_when_unauthenticated(self, create_file: Callable, create_user: Callable,
